...
public class FXMLController {
    ...
    void doAnalizzaAeroporti(ActionEvent event) {
    	...
    	try {
    		...
    		txtResult.appendText("Errore nell'imput");
    		return;
    	}
    	this.model.creaGrafo(x);
    	this.txtResult.appendText("Numero vertici: "+this.model.vertexNumber());
    	this.txtResult.appendText("Numero archi: "+this.model.edgeNumber());
    	//Popola le tendine
    ...
    void doTestConnessione(ActionEvent event) {
    	...
    	if(a1==null || a2==null) {
    		this.txtResult.appendText("Selezione i due aeroporti!");
    		return;
    	}
